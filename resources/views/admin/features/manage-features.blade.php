                                                ...
                                                <tr>
                                                    ...
                                                    <td class="center">
                                                        ...
                                                        @if($feature->publication_status == 1)
                                                            ...
                                                            <a href="{{url('/feature/unpublished'.$feature->id)}}" class="btn btn-success btn-xs" title="UnPublished Feature">
                                                                <i class="fa fa-arrow-up" aria-hidden="true"></i>
                                                            </a>
                                                        @else
                                                            <a href="{{url('/feature/published'.$feature->id)}}" class="btn btn-warning btn-xs" title="Published Feature">
                                                                <i class="fa fa-arrow-up" aria-hidden="true"></i>
                                                            </a>
                                                        @endif
